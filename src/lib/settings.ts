...
export const DEFAULT_GEOFENCE_SETTINGS: GeofenceSettings = {
  ...
  radiusMeters: 200,
  cafeterias: [
    { id: 'divine', name: 'Divine Cafeteria', lat: 7.624629, lng: 4.193443, campus: 'Temporary Site', description: 'Divine Cafe (Oungbona)' },
    { id: 'kemi_bee', name: 'Kemi Bee Cafeteria', lat: 7.624730, lng: 4.193285, campus: 'Temporary Site', description: 'Kemi Bee Cafe' },
    { id: 'jubilee', name: 'Jubilee Cafeteria', lat: 7.618037, lng: 4.202415, campus: 'Permanent Site', description: 'Christoy / Jubilee Cafe' },
    { id: 'bbsf', name: 'BBSF Cafeteria', lat: 7.619532, lng: 4.205877, campus: 'Permanent Site', description: 'BBSF Cafeteria' },
    { id: 'ebunoluwa', name: 'Ebunoluwa (Ebunoluwagrills)', lat: 7.618500, lng: 4.203000, campus: 'Permanent Site', description: 'Ebunoluwa Grills' },
    { id: 'aj_shawarma', name: 'A.J Shawarma & Fast Food', lat: 7.619000, lng: 4.204500, campus: 'Permanent Site', description: 'Boys NH Shawarma' },
    { id: 'vdi_crunchies', name: 'VDI Crunchies', lat: 7.618600, lng: 4.203200, campus: 'Permanent Site' },
    { id: 'fruitjaar', name: 'Fruitjaar', lat: 7.624650, lng: 4.193300, campus: 'Temporary Site' },
  ],
  lastUpdated: new Date().toISOString(),
};
