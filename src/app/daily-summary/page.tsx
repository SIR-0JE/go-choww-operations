    ...
    <AppLayout>
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-8 py-6 sm:py-8 space-y-6 sm:space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div>
            <h1 className="text-2xl font-semibold tracking-tight text-slate-900">Daily summary</h1>
            <p className="text-sm text-slate-500 mt-1">Orders, delivery fees and rider pay, day by day.</p>
          </div>
                ...
                {isLoading ? (
                  ...
                  dailyData.map((row) => (
                    ...
                    >
                      ...
                      {/* Delivery Revenue */}
                      <td className="px-6 py-4 text-right font-semibold text-brand-600 tabular-nums">
                      ...
                      <td className="px-6 py-4 text-center">
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-100 hover:bg-brand-600 hover:text-white text-slate-700 font-semibold text-xs transition-all shadow-sm border border-slate-200 hover:border-brand-600"
                        >
